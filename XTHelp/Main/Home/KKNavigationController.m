...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        colorLayer.frame = CGRectMake(0, -20, self.view.frame.size.width, 64);
        [self.navigationBar.layer addSublayer:colorLayer];
        
        UIColor *left = [UIColor colorWithRed:200/255.0 green:242/255.0 blue:241/255.0 alpha:1.0];
        UIColor *right = [UIColor colorWithRed:0/255.0 green:192/255.0 blue:189/255.0 alpha:1.0];
        colorLayer.colors = @[(__bridge id)left.CGColor,
                              (__bridge id)right.CGColor];
        // 起始点
